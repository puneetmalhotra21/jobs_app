...
import {examaterialst} from 'packs/datalayer/data.js'
      ...
      <div className="">
        <div className="row no-gutter">
          <div className="">
              ...
              {this.state.examaterial.map(job => (
                <ul style={{listStyleType: "none"}}>
                  <li key={job.id}>
                    <div className="card shadow-sm">
                      <div className="card-header bg-light " style={{height:40}}  >
                        <span className="text-warning  float-left" style={{fontWeight:500,fontSize: 11}}> {job.name} Exam Material</span>
                        <span className="float-right" style={{fontSize: 11}}> <b>Price:</b>{job.cost} </span>
                      </div>
                      <div className="card-body ">
                        <h6 className="card-title h1 small font-weight-bold" style={{fontSize: 11}}>{job.state}</h6>
